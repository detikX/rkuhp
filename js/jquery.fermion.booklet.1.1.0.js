 ...
 * Customised by:
 *  2) Hamzeen. H. (http://www.hamzeen.com)
 */
(function (b) {
    ...
    function a(ac, ae, G) {
        var ao, av, S, A, O, L, I, E, o, ad, ah, C, N, aw = new Array(),
            K = new Array(),
            F, ab, Z, Y, W, U, ay, ag, J, s, c, aq, am, ax, az, T, al, ak, R, aj, ai, m, D, B, af, y, e, d, l, X, q, v, r, an, w, k, u, P, n, au, t, g, ap = '<div class="b-page-empty" title="" rel=""></div>',
            ...
            b(document).keyup(function (i) {
                if (i.keyCode == 37) {
                    ...
                    if (av.curr >= (av.pTotal - 2)) {
                        ...
                        document.getElementById('prev_page_button').style.visibility = "visible";
                    } else if (av.curr <= 0) {
                        document.getElementById('next_page_button').style.visibility = "visible";
                        document.getElementById('prev_page_button').style.visibility = "hidden";
                    } else {
                        document.getElementById('next_page_button').style.visibility = "visible";
                        document.getElementById('prev_page_button').style.visibility = "visible";
                    }
        ...
        function aa() {
            ...
            if (av.curr >= (av.pTotal - 2)) {
				document.getElementById('direct_nav').innerHTML = "You are on the last page";
                document.getElementById('next_page_button').style.visibility = "hidden";
                document.getElementById('prev_page_button').style.visibility = "visible";
            } else if (av.curr <= 0) {
				document.getElementById('direct_nav').innerHTML = "You are on the first page";
				document.getElementById('next_page_button').style.visibility = "visible";
                document.getElementById('prev_page_button').style.visibility = "hidden";
            } else {
				document.getElementById('direct_nav').innerHTML = "Currently Browsing Pages " + av.curr + "-" + (av.curr+1) + " of " + (av.pTotal-2);
                document.getElementById('next_page_button').style.visibility = "visible";
                document.getElementById('prev_page_button').style.visibility = "visible";
            }
